...
CREATE INDEX PARCEL_CLAIM_sidx ON TBL_PARCEL_CLAIM(neighbouring_point)
...
VALUES (
    ...
    SDO_DIM_ARRAY(
        ...
        -- Add more SDO_DIM_ELEMENT for 3D or higher dimensions
    ),
    4326
);
COMMIT;
...
CREATE INDEX REGISTERED_CLAIM_sidx ON TBL_REGISTERED_CLAIM(POLYGON)
INDEXTYPE IS MDSYS.SPATIAL_INDEX
